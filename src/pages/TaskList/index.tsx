...
const TaskList: React.FC = () => {
  ...
  try {
    const response = await fetch('https://sherinolivia-ttfsxqentq-uc.a.run.app/task/list', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `${token}`
...
useEffect(() => {
  ...
  const removeTask = async (task_id: number) => {
    try {
        const response = await fetch(`https://sherinolivia-ttfsxqentq-uc.a.run.app/task/delete/${task_id}`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `${token}`
  ...
  const handleStatus = async (task: TaskListInfo) => {
    ...
    try {
      const response = await fetch(`https://sherinolivia-ttfsxqentq-uc.a.run.app/task/update/${task.id}`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `${token}`
